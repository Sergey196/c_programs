...
def writePreamble( output ):
    ...
    output.write( "#include <TestListener.h>\n" )
    output.write( "#include <TestTracker.h>\n" )
    output.write( "#include <TestRunner.h>\n" )
    output.write( "#include <RealDescriptions.h>\n" )
    output.write( "#include <TestMain.h>\n" )
    if options.runner:
