...
macro(CXXTEST_ADD_TEST _cxxtest_testname _cxxtest_outfname)
    message(_cxxtest_testname=${_cxxtest_testname})
    message(_cxxtest_outfname=${_cxxtest_outfname})
    message(ARGN=${ARGN})
    ...
    set_source_files_properties(${_cxxtest_real_outfname} PROPERTIES GENERATED true COMPILE_FLAGS "-fno-access-control")
